        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_MinimumStockQuantity_NonNegative", "[MinimumStockQuantity] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_PartyMatchesType", "([Type] = 1 AND [CustomerId] IS NOT NULL AND [SupplierId] IS NULL) OR ([Type] = 2 AND [SupplierId] IS NOT NULL AND [CustomerId] IS NULL)");
                    table.CheckConstraint("CK_Orders_Status_Valid", "[Status] IN (1, 2, 3)");
                    table.CheckConstraint("CK_Orders_TotalAmount_Positive", "[TotalAmount] > 0");
                    table.CheckConstraint("CK_Orders_Type_Valid", "[Type] IN (1, 2)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovementDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockMovements", x => x.Id);
                    table.CheckConstraint("CK_StockMovements_Quantity_Positive", "[Quantity] > 0");
                    table.CheckConstraint("CK_StockMovements_Type_Valid", "[Type] IN (1, 2)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_Type_Status_OrderDate",
                table: "Orders",
                columns: new[] { "Type", "Status", "OrderDate" });
